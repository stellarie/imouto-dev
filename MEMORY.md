...
- Yuu copies the complete standard agent composition -> preserve every row and required config, including `sampleOverCapGlobResults`. [status: active] [verified: 2026-09-19] [source: hosts/dsh/agent.cordis.yml; scripts/parity.test.ts]
